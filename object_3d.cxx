...
void Object3d::assignAttr(std::string& name, std::vector<std::vector<int>>& vertices, std::list<std::vector<int>>& faces){
    this->name = name;
...
void Object3d::add_line(int key, int value){
    //we need to get the set with as a pointer to the set, since we want to modify the same set in the map
